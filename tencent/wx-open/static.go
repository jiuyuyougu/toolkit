...
const (
	...
	WxAppLoginUrl            = "https://api.weixin.qq.com/sns/component/jscode2session?appid=%s&js_code=JSCODE&grant_type=authorization_code&component_appid=%s&component_access_token=%s"
)
